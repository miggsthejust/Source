...
enum class EUploadResult : uint8
{
	Success,
	UploadFailed,
	SaveFailed,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUOnResult, const EUploadResult, Result);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FUOnProgress, const int32, BytesSent, const int32, BytesReceived, const int32, ContentLength);

/**
 * Download a file from a URL and save it locally.
 */
UCLASS(BlueprintType, Category = "HTTP")
class AIRCOMBOPROTO_API UFileUploader : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Meta = (DisplayName = "Create Uploader"), Category = "HTTP")
	static UFileUploader* MakeUploader();
	...
	*/
	...
	UFileUploader* UploadFile(const FString& Url, FString SavePath);
